...
### Services:
1. **Backend API** - Port 5001 (Node.js/Express)
   - Mood tracking
   - Statistics
   - API endpoints
...
3. **ML API** - Port 5000 (Python/Flask) - Optional
...
│
├── backend/
│   ├── server-simple.js      ← Main backend server (improved)
