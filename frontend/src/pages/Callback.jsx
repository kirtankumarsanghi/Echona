...
const Callback = () => {
  ...
  if (error) {
    return (
      <div className="app-typography-refresh min-h-screen centered-layout">
        <div className="workspace-surface p-8 max-w-md text-center">
  ...
  return (
    <div className="app-typography-refresh min-h-screen centered-layout">
      <div className="workspace-surface p-8 text-center">
